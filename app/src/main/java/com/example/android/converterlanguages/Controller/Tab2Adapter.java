            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case 1:
                        ...
                        View mViewUpdateOne = li.inflate(R.layout.dialog_update_two, null);
                        final EditText updateEdit = mViewUpdateOne.findViewById(R.id.inputEditTwo);
                        updateEdit.setText(deletedModel, TextView.BufferType.EDITABLE);
                        Button okUpdateOne = mViewUpdateOne.findViewById(R.id.btnOkUpdateTwo);
                        Button cancelUpdateOne = mViewUpdateOne.findViewById(R.id.btnCancelUpdateTwo);
                        ...
                        okUpdateOne.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                mDBHelper.updatePascal(newValue, deletedModel);
...
//                                this.notifyDataSetChanged();
    ...
    public Tab2Adapter(ArrayList<String> mList, Context mContext) {
        this.mList = mList;
    ...
    @Override
    public void onBindViewHolder(@NonNull Tab2Adapter.MyViewHolder holder, int position) {
